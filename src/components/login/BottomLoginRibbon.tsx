/**
 * @file BottomLoginRibbon.tsx
 * @description Komponen ribbon informasi di bagian bawah halaman login.
 * Menjelaskan arsitektur isolasi sesi otentikasi per peserta (Multi-Tenant App Maker)
 * dan menyediakan tautan cepat ke dokumentasi katalog atau kontrak API.
 * 
 * Peran dalam UKK:
 * - Menjelaskan sistem arsitektur keamanan multi-tenant yang digunakan dalam simulasi UKK.
 * - Menampilkan micro-interaction hover transisi panah pada tautan navigasi.
 */

import React from "react";
import Link from "next/link"; // Komponen tautan Next.js
import { ShieldCheck, ArrowRight } from "lucide-react"; // Ikon: Perisai Keamanan dan Panah Kanan

export default function BottomLoginRibbon() {
  return (
    <section className="px-4 sm:px-6 my-8">
      {/* Kontainer Utama Ribbon Bernuansa Gelap */}
      <div className="max-w-7xl mx-auto rounded-3xl bg-dark-container p-5 sm:p-6 text-white border border-white/10 flex flex-col md:flex-row items-center justify-between gap-4 shadow-xl">
        ...
        {/* ─── Kiri: Informasi Keamanan Multi-Tenant ─── */}
        ...
        {/* ─── Kanan: Tautan Cepat Dokumentasi / Spesifikasi ─── */}
        <Link
        ...
        >
          ...
          {/* Efek panah bergeser ke kanan saat kursor diarahkan */}
