...
/**
 * Komponen Banner Penjamin Keamanan Data Nota (BottomNotaRibbon)
 *
 * Menghadirkan jaminan keandalan penyimpanan berkas digital:
 * 1. Pesan kepastian bahwa bukti transaksi tersimpan secara aman & permanen pada sistem multi-tenant.
 * 2. Tautan cepat navigasi kembali menuju daftar transaksi nasabah (`/histori`).
 * 3. Diberi kelas `print:hidden` agar tidak ikut tercetak pada kertas fisik struk.
 *
 * @returns JSX Element banner bawah nota
 */
  ...
  return (
    <section className="max-w-7xl mx-auto px-4 sm:px-6 my-8 print:hidden">
      <div className="rounded-3xl bg-dark-container p-6 text-white border border-white/10 flex flex-col md:flex-row items-center justify-between gap-4 shadow-xl">
        {/* Teks Penjamin Keamanan Multi-Tenant */}
        ...
        {/* Tautan Navigasi Kembali ke Riwayat */}
